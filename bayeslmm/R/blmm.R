#' Perform a Bayesian linear mixed effect model
#'
#' @export
#' @param formula An R model formula for mixed effect models
#' @param data The name of a data.frame
#' @param cores The number of CPU cores that the model will use
#' @param seed The initial conditions of the random number generators
...
#' Linear mixed effect facet plot
#'
#' @export
